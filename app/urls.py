...
urlpatterns = [
    ...
    path('proceso/<int:proceso_id>/finanza_list/', RegistroappListView.as_view(), name='finalizar_list'),
    path('proceso/<int:proceso_id>/registrar_app/', RegistroappCreateView.as_view(), name='registro_app_create'),
    path('proceso/<int:proceso_id>/registro_app/<int:pk>/editar/', RegistroappUpdateView.as_view(), name='registro_app_edit'),
    path('proceso/<int:proceso_id>/registro_app/<int:pk>/eliminar/', RegistroappDeleteView.as_view(), name='registro_app_delete'),
